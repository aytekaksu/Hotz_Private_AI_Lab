        ...
        <div className="rounded-3xl border border-border bg-card/80 p-8 shadow-xl backdrop-blur">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={verifying}
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-accent px-4 py-3 text-sm font-semibold text-accent-foreground shadow-lg shadow-accent/20 transition hover:shadow-accent/30 disabled:cursor-not-allowed disabled:opacity-60"
            >
